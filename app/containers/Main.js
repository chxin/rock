  ...
  render() {
    return (
      <View style={{flex:1}}>
        ...
        <TabBar needUpdate={this.props.hasNewVersion} continUnresolvedAlarm={this.props.containAlarm} selectedIndex={this.state.selectedIndex} onSelectedChanged={(index) => this._tabChanged(index)}/>
      </View>
    );
  }
}
...
function mapStateToProps(state) {
  var boot = state.boot;
  var containAlarm=state.alarm.alarmList.get('isContrainUnresolvedAlarm');
