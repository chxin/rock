...
import {loadAlarm,filterDidChanged,firstPage,nextPage,clearFilterResult} from '../../actions/alarmAction';
  ...
  render() {
    return (
      <AlarmView
        ...
        clearFilter={()=>this.props.clearFilterResult()}
...
export default connect(mapStateToProps,{loadAlarm,filterDidChanged,firstPage,nextPage,clearFilterResult})(Alarm);
