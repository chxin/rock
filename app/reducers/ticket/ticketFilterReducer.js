...
function filterParamReset(state,action) {
  ...
  state=state.setIn(['selectDatas','ticketStartTime'],lastMonth);
...
function mergeAllSearchParam(state,action)
{
  ...
  var reqParams={TicketId,TicketStatus,TicketTypes,Hierarchies,StartTime,EndTime};
