...
public class AppInfoModule extends ReactContextBaseJavaModule {
  ...
  public void getAppInfo(Promise promise) {
      ...
      String ossBucket=appInfo.metaData.getString("com.energymost.funkRocking.oss.bucket");
      String prodUri = appInfo.metaData.getString("com.energymost.funkRocking.prodUri");
      String upgradeUri = appInfo.metaData.getString("com.energymost.funkRocking.upgradeUri");
